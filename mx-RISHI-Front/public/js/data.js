...
let pAtkFight = { "atk001": { "sID": "atk001", "sAtkName": "普通攻击", "sAtkType": "learned", "sAtkRangeNear": "true", "sAtkRangeFar": "true", "sTargetSelf": "true", "sTargetEnemy": "true", "sNearEffectSelf": "hurtSelf|physical|10", "sFarEffectSelf": "None", "sNearEffectEnemy": "changeState|finalDamage|multiply|1.1|1", "sFarEffectEnemy": "damage|physical|10" }, "atk002": { "sID": "atk002", "sAtkName": "青元剑盾", "sAtkType": "atkSkill", "sAtkRangeNear": "true", "sAtkRangeFar": "true", "sTargetSelf": "true", "sTargetEnemy": "true", "sNearEffectSelf": "addShield|Wood|50", "sFarEffectSelf": "None", "sNearEffectEnemy": "None", "sFarEffectEnemy": "control|anyNot|2" }, "atk003": { "sID": "atk003", "sAtkName": "剑影斩", "sAtkType": "atkSkill", "sAtkRangeNear": "true", "sAtkRangeFar": "true", "sTargetSelf": "true", "sTargetEnemy": "true", "sNearEffectSelf": "hurtSelf|Wood|50", "sFarEffectSelf": "None", "sNearEffectEnemy": "changeState|damage|add|20|3", "sFarEffectEnemy": "damage|Wood|50" }, "atk004": { "sID": "atk004", "sAtkName": "冰影闪", "sAtkType": "equipSkill", "sAtkRangeNear": "true", "sAtkRangeFar": "false", "sTargetSelf": "true", "sTargetEnemy": "false", "sNearEffectSelf": "changeState|speed|add|20|2", "sFarEffectSelf": "None", "sNearEffectEnemy": "None", "sFarEffectEnemy": "None" } }
// 所有道具信息
let ITEMS = new Map();
let ATKFIGHT = new Map();
...
function tableDataInit() {
    ...
    for (let key in pAtkFight) {
        ATKFIGHT.set(key, pAtkFight[key]);
    }
}
