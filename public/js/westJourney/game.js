$(function () {
    ...
    function initScreen() {
        ...
        if (winWide <= 1024) {
            //1024及以下分辨率
            // 小屏幕 竖屏
            $("#css").attr("href", "/public/css/westJourney/index2.css");
        } else {
            // 大屏幕 横屏
            $("#css").attr("href", "/public/css/westJourney/index.css");
            //是宽屏
            wideScreen = true;
        }
    ...
    function getImg(number) {
        ...
        switch (number) {
            case 3:
                imgUrl = `url('/public/img/westJourney/shitu_shaseng.jpg')`;
                break;
            case 5:
                imgUrl = `url('/public/img/westJourney/shitu_wukong.jpg')`;
                break;
            case 8:
                imgUrl = `url('/public/img/westJourney/shitu_bajie.jpg')`;
                break;
            case 10:
                imgUrl = `url('/public/img/westJourney/shitu_shifu.jpg')`;
                break;
            case 11:
                imgUrl = `url('/public/img/westJourney/yaoguai_hongmang.jpg')`;
                break;
            case 12:
                imgUrl = `url('/public/img/westJourney/yaoguai_shiziguai.jpg')`;
                break;
            case 13:
                imgUrl = `url('/public/img/westJourney/yaoguai_baigujing.jpg')`;
                break;
            case 15:
                imgUrl = `url('/public/img/westJourney/fo_guanyin.jpg')`;
                break;
            case 16:
                imgUrl = `url('/public/img/westJourney/fo_rulai.jpg')`;
                break;
            default:
                imgUrl = '';
                break;
